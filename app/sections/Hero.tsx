    ...
    <section className="min-h-[100vh] flex flex-col justify-end md:justify-center max-w-7xl mx-auto pt-20 md:pt-24 pb-24 md:pb-12 px-4 md:px-6 relative overflow-hidden">
      ...
      <div className="relative z-10 w-full flex flex-col items-start md:items-end text-left md:text-right space-y-6 md:space-y-8 mt-16 md:mt-0">
        <div className="flex flex-col items-start md:items-end max-w-3xl w-full">
          ...
          <h1 className="text-4xl sm:text-4xl md:text-6xl lg:text-[6rem] xl:text-[7rem] font-bold leading-[0.85] tracking-tighter mb-4 md:mb-5 select-none text-neutral-900">
            MERN Developer
          </h1>

          {/* Tagline */}

          <span className="w-full md:w-3/4 transition-opacity duration-500 text-[14px] md:text-[16px]  text-neutral-700 tracking-normal font-medium leading-[1.65] line-clamp-2 mb-8 md:mb-10 mt-6 sm:mt-0 md:mt-6 ">
            Specialized in building enterprise analytics dashboards and scalable
            web platforms. Led development of real-time vehicle tracking systems
          </span>
